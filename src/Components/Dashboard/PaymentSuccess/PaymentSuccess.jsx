    ...
    return (
        <div className='max-w-7xl mx-auto flex justify-center items-center min-h-screen'>
            ...
            <img className='w-44 mx-auto mix-blend-darken' src="https://i.ibb.co.com/jkWC6Qn3/contactless-payment-15575616.gif" alt="" />
             ...
             <br />
             <Link to={"https://foodhub-d3e1e.web.app/restaurants"}><p className=' bg-[#ff0000d8] text-white rounded-xl hover:bg-[#ff0000d8] hover:text-white  text-center mt-3 flex items-center justify-center gap-2 '>Order More Food <PiHamburgerThin /></p></Link>
            </div>
